...
class PrintFieldsWin(Gtk.Window):
    ...
    def __init__(self, fields, fieldsdic, printfields, back_clicked_cb, next_clicked_cb, parent, edit):
        ...
        self.set_title(_('fsTimer - Choose results fields'))
        ...
        label1_2 = Gtk.Label()
        label1_2.set_markup(_('<b>Computed results</b>'))
        vbox.pack_start(label1_2, False, False, 0)
        btn_time = Gtk.CheckButton(_('Time'))
        if 'Time' in self.printfields:
            btn_time.set_active(True)
        # Pace buttons
        btn_pace = Gtk.CheckButton(_('Pace'))
        label_pace = Gtk.Label(_('     Distance:'))
